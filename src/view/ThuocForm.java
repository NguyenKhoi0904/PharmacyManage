 ...
 * @author Admin
 */
public class ThuocForm extends javax.swing.JFrame {
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(ThuocForm.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
