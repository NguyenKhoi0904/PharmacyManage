 ...
 * @author Admin
 */
public class ThemThuocForm extends javax.swing.JFrame {

    /**
     * Creates new form ThemThuocForm
     */
    public ThemThuocForm(ThuocForm1 parentForm) {
    ...
    private void btnLuuActionPerformed(java.awt.event.ActionEvent evt) {// GEN-FIRST:event_btnLuuActionPerformed
        ...
        if (    txtMaThuoc.getText().trim().isEmpty() ||
                txtTenThuoc.getText().trim().isEmpty() ||
        ...
        // thêm thuốc vào db
        if (BUSManager.thuocBUS.addThuoc(this.getThuoc())) {
            JOptionPane.showMessageDialog(this, "Thêm thuốc mới thành công");

            // reload lại bảng thuốc
            this.parentForm.loadData();

            // đóng form
            this.setVisible(false);
        } else {
            // JOptionPane.showMessageDialog(this, "Lỗi thông tin nhập");
        }
        ...
        // JOptionPane.showMessageDialog(this, "Đã Thêm thuốc thành công!");
    ...
    private ThuocDTO getThuoc() {
        // DanhMucThuocDTO dmt = (DanhMucThuocDTO) comboDanhMuc.getSelectedItem();
        return new ThuocDTO(
                Integer.parseInt(txtMaThuoc.getText()),
                // dmt != null ? dmt.getMaDmt() : 0,
                Integer.parseInt(txtDanhMuc.getText()),
                txtTenThuoc.getText(),
                new BigDecimal(txtGia.getText()),
                txtDonViTinh.getText(),
                txtNhaSanXuat.getText(),
                txtXuatXu.getText(),
                "chưa thêm img path trong ThemThuocForm",
                1);
    }
    ...
    // java.util.logging.Logger.getLogger(ThemThuocForm.class.getName()).log(java.util.logging.Level.SEVERE,
    // null,
    // ex);
    ...
    // public void run() {
    // new ThemThuocForm().setVisible(true);
    // }
    // });
    // }
