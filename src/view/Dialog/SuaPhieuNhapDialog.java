...
public class SuaPhieuNhapDialog extends JDialog {
    ...
    public SuaPhieuNhapDialog(PhieuNhapForm parent, PhieuNhapDTO phieuNhapDTO) {
        super(parent, "Thêm Phiếu Nhập Mới", true);
        dsChiTiet = BUSManager.chiTietPnBUS.getListChiTietPnByMaPn(phieuNhapDTO.getMaPn());
        setSize(1280, 720);
        ...
        gbc.gridx = 1;
        JLabel lblMaPn = new JLabel(String.valueOf(phieuNhapDTO.getMaPn()));
        ...
        gbc.gridx = 1;
        NhanVienDTO nhanvien = BUSManager.nhanVienBUS.getNhanVienByMaNv(phieuNhapDTO.getMaNv());
        lblNhanVien = new JLabel(nhanvien.toString());
        ...
        gbc.gridx = 1;
        JLabel lblThoiGian = new JLabel(phieuNhapDTO.getThoiGianNhap().toString());
        ...
        txtDiadiem.setText(phieuNhapDTO.getDiaDiem());
        ...
        btnThem.addActionListener(e -> {
            ...
            ThemChiTietPhieuNhapDialog dialog = new ThemChiTietPhieuNhapDialog(
                    this,
                    String.valueOf(phieuNhapDTO.getMaPn()));
        ...
        btnOK.addActionListener(e -> {
            ...
            // cập nhật phiếu nhập vào db
            if (BUSManager.phieuNhapBUS.updatePhieuNhap(phieuNhapDTO, dsChiTiet)) {

                JOptionPane.showMessageDialog(parent, "Cập Nhật Phiếu Nhập Thành Công");
